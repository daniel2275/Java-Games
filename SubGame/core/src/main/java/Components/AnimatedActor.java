...
public class AnimatedActor extends Actor implements Pausable {
    ...
    public void act(float delta) {
        ...
        if (!paused) {
            ...
            if (!overrideActive) updateMovementState();
            updateAnimation();
    ...
    private void updateAnimation() {
        if (overrideActive) {
            ...
            if (currentAnimation.isAnimationFinished(stateTime)) {
                ...
                tempAnimation = idleAnimation; // or any default animation
            }
        } else {
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        // Define looping animation If SUB all are looping
        loops = (tempAnimation == idleAnimation || tempAnimation == moveAnimation);
        if (isSub) {
            loops = (tempAnimation != sunkAnimation && tempAnimation != hitAnimation);
        } else {
            loops = (tempAnimation == idleAnimation || tempAnimation == moveAnimation);
        }
